          ...
          <div key={i} style={{ padding: "10px 14px", borderBottom: "1px solid #F1F5F9", display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ fontSize: 9, color: "#94A3B8", marginTop: 1 }}>
                {prop.rule === 'rule1' ? 'Rule1:ゼロ販売' : prop.rule === 'rule2' ? 'Rule2:低PI' : prop.rule === 'rule3' ? 'Rule3:廃棄リスク' : prop.rule === 'rule4' ? 'Rule4:統合候補' : '高PI'} | PI:{prop.piValue} (中央値:{prop.categoryAvgPi}) | {p.row}段 F:{p.face}→{prop.action === 'カット' ? '撤去' : prop.action === 'フェース減' ? Math.max(1, p.face - 1) : Math.min(6, p.face + 1)}
              </div>
            </div>
